...
import { updateUserPasswordById } from "@/actions/users";
...
export default function ChangPasswordForm({
  ...
  async function onSubmit(data: PasswordProps) {
    ...
    try {
      if (editingId) {
        const res = await updateUserPasswordById(editingId, data);
        if (res?.status === 403) {
          setLoading(false);
          ...
          <Alert>
            ...
            <AlertDescription className="text-sm">
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>
                  ต้องประกอบด้วย <b>ตัวพิมพ์ใหญ่</b>, <b>ตัวพิมพ์เล็ก</b>,{" "}
                  <b>ตัวเลข</b>, และ
                  <b> อักขระพิเศษ</b> อย่างน้อยอย่างละ 1 ตัว
                </li>
                <li>
