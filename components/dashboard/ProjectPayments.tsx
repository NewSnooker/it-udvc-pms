        ...
        <ScrollArea className="h-auto md:h-[calc(100vh-11rem)] mt-4">
          {userProject.map((project) => (
            <div
              ...
              className={`px-2 w-full inline-flex cursor-pointer items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50
              ${
