      ...
      <div className="mt-2">
        <div className="relative rounded-md ">
          ...
          <input
            ...
            className={cn(
              "block w-full rounded-md border-0 py-2 text-zinc-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-zinc-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 text-sm",
